...
public class SkyBoxModel : Model
{
    ...
    public override void Draw(Matrix4 modelMatrix, Matrix4 viewMatrix, Matrix4 projectionMatrix)
    {
        GL.DepthMask(false);
        ...
        base.Draw(modelMatrix, new Matrix4(new Matrix3(viewMatrix)), projectionMatrix);
        GL.DepthMask(true);
    }
